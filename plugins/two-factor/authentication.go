...
func (t *twoFactorPlugin) InitiateTwoFactorSetup(ctx context.Context, user *UserWithTwoFactor, password string) (*TwoFactorSetupURI, error) {
...
func (t *twoFactorPlugin) FinalizeTwoFactorSetup(ctx context.Context, user *UserWithTwoFactor, code string) error {
	if user.TwoFactorEnabled {
...
func (t *twoFactorPlugin) DisableTwoFactor(ctx context.Context, userID any, password string) error {
...
func (t *twoFactorPlugin) checkPassword(user *limen.User, password string) error {
	...
	credentialPasswordAPI := plugin.(credentialpassword.API)
...
func (t *twoFactorPlugin) verifyLoginCode(ctx context.Context, userID any, code string, method TwoFactorMethod) error {
